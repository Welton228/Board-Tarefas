...
import { Loader2 as LoaderIcon } from 'lucide-react'; // ✅ Importação limpa
...
interface CreateTaskFormProps {
  onTaskSaved: (data: TaskFormData) => Promise<void>;
  onClose?: () => void;
}
 ...
 */
const CreateTaskForm: React.FC<CreateTaskFormProps> = memo(({ onTaskSaved, onClose }) => {
      ...
      >
        ...
        <div className="space-y-5">
          <div className="space-y-2">
            <label htmlFor="task-title" className="text-xs font-bold text-blue-400/80 uppercase tracking-widest ml-1">
              Título da Atividade
            </label>
            <input
              id="task-title"
          ...
          <div className="space-y-2">
            <label htmlFor="task-desc" className="text-xs font-bold text-blue-400/80 uppercase tracking-widest ml-1">
              Detalhes (Opcional)
            </label>
            <textarea
              id="task-desc"
